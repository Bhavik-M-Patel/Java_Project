                ...
                <div class="login_form">
                  <form action="#">
                    <div class="mb-2 mr-sm-2">
                      ...
                      <input type="text" class="form-control" id="formGroupExampleInput" placeholder="him45@gmail.com..">
                    </div>
        ...
        <div class="col-sm-12 col-lg-6">
          <div class="sign_up_form inner_page bgc-white">
            ...
            <form action="#">
              ...
              <button type="submit" class="btn btn-signup btn-block btn-dark mb0">Submit</button>
            </form>
          </div>
        </div>
			</div>
