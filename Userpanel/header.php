    ...
    <div class="container"> 
      ...
      <nav> 
        ...
        <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing"><a href="myaccount.php"><span class="icon flaticon-button"></span><span class="dn-lg"> LOGIN </span></a></li>
