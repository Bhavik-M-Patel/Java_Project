...
<!-- Mirrored from creativelayers.net/themes/houzing-html/page-dashboard-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jan 2022 08:56:27 GMT -->
<head>
<meta charset="utf-8">
					...
					<div class="row">
							...
							<div class="dashboard_navigationbar dn db-lg">
								<div class="dropdown">
									...
									<ul id="myDropdown" class="dropdown-content">
										...
										<li><a href="dashboard-invoices.php"><span class="flaticon-invoice"></span> My Invoices</a></li>
										<li><a href="dashboard-message.php"><span class="flaticon-mail-inbox-app"></span> Inbox</a></li>
										<li><a class="active" href="dashboard-logout.php"><span class="flaticon-logout"></span> Logout</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-12 mb50">
							<div class="breadcrumb_content">
								<h2 class="breadcrumb_title">Logout</h2>
								<p class=""></p>
							</div>
						</div>
					</div>
					...
					<div class="login_form inner_page bgc-white mb30">
                      ...
                      <h4 class="title">Logout</h4>
							<div class="mb-2 mr-sm-2">
								<label for="formGroupExampleInput" class="form-label mb0">Thankyou for using STAYSEARCH.COM</label>
							<button type="submit" class="btn btn-log btn-block btn-thm mt20">Logout</button>
							<div class="row mt10">
