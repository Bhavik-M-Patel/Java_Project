...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into tbl_property(seller_name,property_type,property_details,property_city,property_area,property_image) values('{$pname}','{$ptype}','{$pdetails}','{$pcity}','{$pcode}','{$pimage}')") or die(mysqli_error($connection));
                        ...
                        <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="horizontal-form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="focusedinput" name="pname" required >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8"><textarea name="pdetails" id="txtarea1" cols="50" rows="4" class="form-control1" ></textarea></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtarea1" class="col-sm-2 control-label"> Address</label>
                                        <div class="col-sm-8"><textarea name="paddress" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8"><input type="text" class="form-control1 ng-invalid ng-invalid-required ng-valid-pattern ng-touched" ng-model="model.number" ng-pattern="/[0-9]/" name="pcode" required></div>
                                    </div>
